...
# Lab 04
# Lab Section: 16
# Sources, people worked with, help given to: TAs
...
print(f'{max_temp} is the highest recorded temperature')
print(f"{min_temp} is the lowest recorded temperature")
